...
function Form3({ onSubmit }) {
  ...
  return (
    <div className="h-screen w-[100%] md:w-[79.3%]  md:py-4 relative flex items-center justify-center m-auto">
      <div className="w-full h-[600px] sm:h-auto pb-4">
        <div className=" bg-white rounded-[20px] p-10 lg:p-6 xl:p-10 w-[90%] md:w-[800px] mx-auto">
