      ...
      <div className="flex items-center justify-center h-full md:py-0">
        <div className=" bg-white rounded-[20px] py-10 px-5 lg:p-10  w-[86%] md:w-[460px]">
          ...
          <p className=" font-normal text-lg text-center my-7">
            We've got <span className=" font-bold">{Tests.length} levels</span> to conquer,
            but beware, only the bravest make it to level {Tests.length}. Are you up for the
            challenge? Let's see what you've got!{" "}
            <span className=" font-bold">Good luck!</span>
          </p>
          <div className=" text-end">
            <button onClick={() => handleContinue()} className=" text-white text-lg font-normal bg-[#66BCB4] rounded-[10px] py-[10px] w-full md:w-auto px-[30px] text-center">
              Continue
            </button>
          </div>
        </div>
