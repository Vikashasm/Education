        ...
        <div className=" flex flex-col min-h-[68vh] justify-between min_h_71">
          <div>
            <div className=" md:text-md lg:text-2xl text-black font-medium py-2 h-16 capitalize overflow-hidden flex ">
              <span className=" z-30  pe-1 bg-[#FFFFFF99] ps-[18px] overflow-hidden">
                {" "}
                Question {state + 1} :
              </span>
            ...
            <div className=" flex justify-between gap-8 flex-wrap overflow-hidden px-4">
              {questions[1].part2[state].answeroption.map((value, index) => {
                return (
                  <input
                    key={index}
                    ...
                    onClick={() =>
                      Mhandelchange(
                        questions[1].part2[state].answeroption[index].iscorrect,
                        value.optionNo
                      )
                    }
                  />
